  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* MAIN CONTENT GRID - Split for Sidebar */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          
          {/* LEFT COLUMN: Main Dashboard Stats & Platforms (9 cols) */}
          ...
          {/* RIGHT COLUMN: Sidebar Notes (4 cols) */}
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-4">You are connected to the live database.</p>
              <div className="space-y-2 text-xs">
                <p><span className="font-bold text-orange-600">Codeforces:</span> Updates live via API.</p>
                <p><span className="font-bold text-orange-600">Others:</span> Saves handle to DB; requires backend worker for live scraping.</p>
              </div>
            </div>

            {/* Score Weights (XP) Card */}
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-4">
                {[
                  { name: 'LeetCode', weight: '1.2', color: 'text-blue-600', bg: 'bg-blue-50' },
                  { name: 'Codeforces', weight: '1.2', color: 'text-blue-600', bg: 'bg-blue-50' },
                  { name: 'CodeChef', weight: '1.0', color: 'text-green-600', bg: 'bg-green-50' },
                  { name: 'HackerRank', weight: '0.8', color: 'text-orange-600', bg: 'bg-orange-50' },
                  { name: 'GeeksForGeeks', weight: '0.5', color: 'text-gray-600', bg: 'bg-gray-50' },
                ].map((item) => (
                  <div key={item.name} className="flex justify-between items-center text-sm">
                    <span className="text-gray-600">{item.name}</span>
                    <span className={`font-bold px-2 py-1 rounded-md text-[10px] ${item.bg} ${item.color}`}>
                      × {item.weight}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-6 rounded-2xl shadow-lg text-white">
              ...
              <p className="text-sm leading-relaxed opacity-90">
                Want to climb the leaderboard faster? Focus on solving problems on high-weight platforms like <span className="font-bold underline">Codeforces</span> and <span className="font-bold underline">LeetCode</span>.
              </p>
            </div>
