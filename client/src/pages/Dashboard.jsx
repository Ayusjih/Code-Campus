        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
            ...
            <div className="lg:col-span-3 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Total Problems */}
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow relative overflow-hidden group">
                         ...
                         <div className="relative z-10">
                            <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">Total Problems</p>
                    ...
                    {/* College Rank */}
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow relative overflow-hidden group">
                         <div className="absolute right-0 top-0 w-24 h-24 bg-yellow-50 rounded-bl-full -mr-4 -mt-4 opacity-50 group-hover:scale-110 transition-transform"></div>
                         <div className="relative z-10">
                            <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">College Rank</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow relative overflow-hidden group">
                         ...
                         <div className="relative z-10">
                            <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">Active Platforms</p>
                ...
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                        Your Platforms <span className="text-xs font-bold text-white bg-blue-600 px-2 py-1 rounded-full shadow-sm shadow-blue-200">{platforms.length} Connected</span>
                    </h2>
            ...
            <div className="lg:col-span-1 space-y-6">
                ...
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="bg-amber-50 p-3 rounded-lg border border-amber-100">
                        <p className="text-[10px] text-amber-800 font-bold">⚠️ Resets daily at 12:00 AM</p>
                    </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-5 rounded-2xl shadow-md text-white">
                    ...
                    <p className="text-xs text-indigo-100 leading-relaxed">
                        Want to climb the leaderboard faster? Focus on solving problems on high-weight platforms like <span className="font-bold text-white">Codeforces</span> and <span className="font-bold text-white">LeetCode</span>.
                    </p>
                </div>
